...
def result2json(result, stage):
    if stage:
        from dataset.AIAI_features import class_dict_stage 
        class_dict = class_dict_stage[stage]
    else:
        from dataset.AIAI_features import class_dict
    result_file = []
